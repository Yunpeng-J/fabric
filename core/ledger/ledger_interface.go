...
type PeerLedger interface {
	...
	CommitWithPvtData(blockAndPvtdata *BlockAndPvtData, committedTxs chan<- *dependency.Transaction) error
...
type TxSimulator interface {
	...
	SetOracle(namespace string, key string, value []byte) error
}
...
type BlockAndPvtData struct {
	...
	UnblockedTxs   <-chan *dependency.Transaction
}
