...
//
// This is the equivalent of PyEval_EvalFrame
func RunFrameWithGas(frame *py.Frame, gas int) (res py.Object, err error) {
	var vm = Vm{
		frame: frame,
	}
	...
	for vm.why == whyNot{
		gas--
		if gas ==0{
			return nil, fmt.Errorf("Ran out of gas")
		}
...
func EvalCodeExWithGas(co *py.Code, globals, locals py.StringDict, args []py.Object, kws py.StringDict, defs []py.Object, kwdefs py.StringDict, closure py.Tuple, gas int) (retval py.Object, err error) {
	total_args := int(co.Argcount + co.Kwonlyargcount)
	n := len(args)
	var kwdict py.StringDict
...
func RunWithGas(globals, locals py.StringDict, code *py.Code, closure py.Tuple, gas int) (res py.Object, err error) {
	return EvalCodeExWithGas(code,
		globals, locals,
		nil,
		nil,
		nil,
